...
export default function LackawannaPage() {
  return (
    <div className="min-h-screen bg-[#efece9]">
      ...
      <section className="relative h-[50vh] mt-[72px] overflow-hidden">
        <img
          src="https://ext.same-assets.com/896116978/2656462211.jpeg"
          alt="Kitchen and Bathroom Remodeling in Lackawanna, NY"
      ...
      <section className="bg-white py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-[#624f37]">
            ...
            <span>/</span>
            <Link href="/locations/lackawanna" className="text-[#2f2820] font-semibold">Lackawanna, NY</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#2f2820]">
              Premier Remodeling Services in Lackawanna, NY
            </h2>
            <p className="text-lg text-[#624f37] mb-6 leading-relaxed">
              Sireika Renovations is proud to serve the Lackawanna community with exceptional <Link href="/services/kitchen-remodeling" className="text-[#926540] hover:underline font-semibold">kitchen remodeling</Link> and <Link href="/services/bathroom-remodeling" className="text-[#926540] hover:underline font-semibold">bathroom remodeling</Link> services. As your local renovation experts, we understand the unique character and style preferences of Lackawanna homeowners.
            </p>
            <p className="text-lg text-[#624f37] mb-8 leading-relaxed">
              Whether you're renovating a lakefront property along Lake Erie or updating a home in the city center, our team brings years of experience and a commitment to quality that Lackawanna residents trust. We combine premium materials, expert craftsmanship, and personalized design to create spaces that enhance your home's value and your quality of life.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="p-8 border-none shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-[#624f37] mb-6">
                  Transform your Lackawanna kitchen with our comprehensive remodeling services. From custom cabinetry to modern appliances, we create kitchens that are both beautiful and functional.
                </p>
              ...
              <Card className="p-8 border-none shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-[#624f37] mb-6">
                  Create your dream bathroom with Sireika Renovations. We specialize in luxury bathroom renovations that combine style, comfort, and functionality for Lackawanna homes.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-[#624f37]">
                    <CheckCircle className="w-5 h-5 text-[#926540] mr-2 flex-shrink-0" />
            ...
            <div className="bg-[#efece9] p-8 rounded-lg mb-12">
              <h3 className="text-2xl font-bold mb-6 text-[#2f2820]">Why Lackawanna Homeowners Choose Sireika Renovations</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-bold text-[#2f2820] mb-2">Local Expertise</h4>
                  <p className="text-[#624f37]">We understand Lackawanna homes and what works best for this community.</p>
                </div>
                <div>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4 text-[#2f2820]">
                Ready to Start Your Lackawanna Renovation Project?
              </h3>
