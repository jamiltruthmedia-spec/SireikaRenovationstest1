    ...
    <div className="min-h-screen bg-[#efece9]">
      ...
      <section className="relative h-[50vh] mt-[72px] overflow-hidden">
        <img
          ...
          alt="Kitchen and Bathroom Remodeling in Hamburg, NY"
      ...
      <section className="bg-white py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-[#624f37]">
            ...
            <span>/</span>
            <Link href="/locations/hamburg" className="text-[#2f2820] font-semibold">Hamburg, NY</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="p-8 border-none shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-[#624f37] mb-6">
                  Transform your Hamburg kitchen with our comprehensive remodeling services. From custom cabinetry to modern appliances, we create kitchens that are both beautiful and functional.
                </p>
              ...
              <Card className="p-8 border-none shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-[#624f37] mb-6">
                  Create your dream bathroom with Sireika Renovations. We specialize in luxury bathroom renovations that combine style, comfort, and functionality for Hamburg homes.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center text-[#624f37]">
                    <CheckCircle className="w-5 h-5 text-[#926540] mr-2 flex-shrink-0" />
            ...
            <div className="bg-[#efece9] p-8 rounded-lg mb-12">
              <h3 className="text-2xl font-bold mb-6 text-[#2f2820]">Why Hamburg Homeowners Choose Sireika Renovations</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-bold text-[#2f2820] mb-2">Local Expertise</h4>
                  <p className="text-[#624f37]">We understand Hamburg homes and what works best for this community.</p>
                </div>
                <div>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4 text-[#2f2820]">
                Ready to Start Your Hamburg Renovation Project?
              </h3>
